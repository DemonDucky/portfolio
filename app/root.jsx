    ...
    <html lang="en">
      ...
      <body className={'font-normal-text text-baseText bg-baseBackground'}>
        <header>
          <nav
            className={
              'lg:hidden px-4 py-2 bg-baseBackground fixed w-full place-items-center grid grid-cols-3 gap-x-2 rounded-b-lg h-16'
            }
          >
          ...
          <nav
            className={
              'hidden lg:grid px-4 py-2 bg-baseBackground fixed w-full rounded-b-lg h-16 place-items-center grid-cols-3'
            }
          >
            <Typography variant={'h5'} className={'place-self-start my-auto font-normal-text font-normal'}>
              luong.tuananh.biz@gmail.com
            </Typography>
            <Typography variant={'h5'} className={'font-normal-text font-normal'}>
              Tuan Anh Luong
            </Typography>
